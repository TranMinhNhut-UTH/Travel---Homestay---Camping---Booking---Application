...
var ocelotConfiguration = new ConfigurationBuilder()
    .AddInMemoryCollection(new Dictionary<string, string?>
    {
        ...
        { "Routes:15:DownstreamHostAndPorts:0:Port", "5004" }, // Assuming DealerService runs on port 5004

        // New route for /api/vehicletypes
        { "Routes:16:UpstreamPathTemplate", "/api/vehicletypes" },
        { "Routes:16:UpstreamHttpMethod:0", "GET" },
        { "Routes:16:DownstreamPathTemplate", "/api/vehicletypes" },
        { "Routes:16:DownstreamScheme", "http" },
        { "Routes:16:DownstreamHostAndPorts:0:Host", "localhost" },
        { "Routes:16:DownstreamHostAndPorts:0:Port", "5068" }, // Assuming VehicleService handles vehicletypes

        // New route for images
        { "Routes:17:UpstreamPathTemplate", "/images/{everything}" },
        { "Routes:17:UpstreamHttpMethod:0", "GET" },
        { "Routes:17:DownstreamPathTemplate", "/images/{everything}" },
        { "Routes:17:DownstreamScheme", "http" },
        { "Routes:17:DownstreamHostAndPorts:0:Host", "localhost" },
        { "Routes:17:DownstreamHostAndPorts:0:Port", "5068" }, // Assuming VehicleService serves images

        // NEW ROUTE FOR ADMIN USERS (specific POST /api/admin/users) - Placed first for priority
        { "Routes:18:UpstreamPathTemplate", "/api/admin/users" },
        { "Routes:18:UpstreamHttpMethod:0", "POST" },
        { "Routes:18:DownstreamPathTemplate", "/api/admin/users" },
        ...
        { "Routes:19:UpstreamPathTemplate", "/api/admin/users/{everything}" },
        { "Routes:19:UpstreamHttpMethod:0", "GET" },
        { "Routes:19:UpstreamHttpMethod:1", "PUT" },
        { "Routes:19:UpstreamHttpMethod:2", "DELETE" },
        { "Routes:19:DownstreamPathTemplate", "/api/admin/users/{everything}" },
        { "Routes:19:DownstreamScheme", "http" },
        { "Routes:19:DownstreamHostAndPorts:0:Host", "localhost" },
        { "Routes:19:DownstreamHostAndPorts:0:Port", "7001" }, // Assuming User Service handles admin users
