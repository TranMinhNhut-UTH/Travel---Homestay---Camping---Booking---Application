...
module.exports = (conf, srcGlob) => {
  ...
  const buildJsTask = function (cb) {
    setTimeout(function () {
      webpack(require('../../../../../../../Downloads/sneat-bootstrap-html-admin-template-free-v2.0.0/sneat-bootstrap-html-admin-template-free-v2.0.0/sneat-bootstrap-html-admin-template-free/webpack.config'), (err, stats) => {
        if (err) {
